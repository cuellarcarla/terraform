...
exit
EOF
cat crea-wordpress-db.sql | sudo mysql -u admin -pSuperSecret123 -h my-rds.cf2duuwyxonv.us-east-1.rds.amazonaws.com
sudo apt update
...
sudo -u www-data sed -i 's/localhost/my-rds.cf2duuwyxonv.us-east-1.rds.amazonaws.com/' /srv/www/wordpress/wp-config.php